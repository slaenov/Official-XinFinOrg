                            ...
                            <div class="mt-sm-5 mt-md-0 mt-lg-0">
                                <div class="d-flex justify-content-center align-items-center">
                                    <picture>
                                        ...
                                        <source srcset="assets/images/networkImage.png" type="image/png" class="img-fluid" alt="XDC Network: Powered by XDC Protocol">
                                        <!-- D: Fallback -->
                ...
                <div class="card overflow-hidden pt-4 pb-4 px-3 bg-lightgray br-20 border-0">
                    <div class="card-info">
                        ...
                        <div class="cardHead fw-600 lh-1">
                            <span class="counter-api counter" id="transactionCount">1,145.55 </span>
            ...
            <div class="col-lg-4 col-md-4 mt-2 mb-2">
                <div class="card overflow-hidden pt-4 pb-4 px-3 bg-lightgray br-20 border-0">
                    <div class="card-info">
                        ...
                        <div class="cardHead fw-600 lh-1">
                            <span class="counter-api counter" id="contractNumber">774,832</span>
            ...
            <div class="col-lg-4 col-md-4 mt-2 mb-2">
                <div class="card overflow-hidden pt-4 pb-4 px-3 bg-lightgray br-20 border-0">
                    <div class="card-info">
                        ...
                        <div class="cardHead fw-600 lh-1"><span class="counter-api counter" id="masternodes">108</span>/<span class="counter-api counter" id="totalnodes">332</span></div>
                        <div class="statsIcon">
                            ...
                            <div class="mt-sm-5 mt-md-0 mt-lg-0">
                                <div class="d-flex justify-content-center align-items-center">
                                    <picture>
                                        ...
                                        <source srcset="assets/images/walletsImage.png" type="image/png" class="img-fluid" alt="XDC Wallets">
                                        <!-- D: Fallback -->
                                        <img src="assets/images/walletsImage.png" class="img-fluid" alt="XXDC Wallets">
                                    </picture>
                                </div>
                            </div>
                        </div>
