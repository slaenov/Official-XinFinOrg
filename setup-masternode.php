            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mt-2 mb-2">
                <div class="card h-100 overflow-hidden pt-4 pb-4 px-3 bg-light75 br-20 border-0">
                    <div class="card-info text-center w-100">
                        ...
                        <div class="fw-600 lh-1 fs-2 mb-3 counter-api"><span id="mn-observernodes">Unlimited</span></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mt-2 mb-2">
                <div class="card h-100 overflow-hidden pt-4 pb-4 px-3 bg-light75 br-20 border-0">
                    <div class="card-info text-center w-100">
                        ...
                        <div class="fw-600 lh-1 fs-2 mb-3"><span class="counter-api counter" id="tvl">3030.87</span> <span id="tvltext">M</span></div>
        ...
        <div class="row row-flex">
            <div class="col-lg-12">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-6 mt-2 mb-2">
                        <a href="https://www.bridge.xyz/" target="_blank">
                            <div class="h-100 card px-3 p-4 bg-lightgray br-20 border-0">
                                <div class="card-info text-center">
                                    <img src="assets/images/inside-page/masternode/bridge-stripe-company-light.svg" class="center logoFs img-fluid iconL" alt="bridge.xyz" />
                                    <img src="assets/images/inside-page/masternode/bridge-stripe-company.svg" class="center logoFs img-fluid iconD" alt="bridge.xyz" />
                                    <p class="card-info-desc fs-7 br-20 mb-0">Bridge</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-6 mt-2 mb-2">
                        <a href="https://linkpool.com/" target="_blank">
                            <div class="h-100 card px-3 p-4 bg-lightgray br-20 border-0">
                                <div class="card-info text-center">
                                    <img src="assets/images/inside-page/masternode/linkpool-light.svg" class="center logoFs img-fluid iconL" alt="linkpool.com" />
                                    <img src="assets/images/inside-page/masternode/linkpool.svg" class="center logoFs img-fluid iconD" alt="linkpool.com" />
                                    <p class="card-info-desc fs-7 br-20 mb-0">LinkPool</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-6 mt-2 mb-2">
                        <a href="https://www.clearstreet.io/" target="_blank">
                            <div class="h-100 card px-3 p-4 bg-lightgray br-20 border-0">
                                <div class="card-info text-center">
